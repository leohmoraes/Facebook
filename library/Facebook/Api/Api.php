...
abstract class Api
{
    ...
    public static $CURL_OPTS = array(
        ...
        CURLOPT_TIMEOUT        => 60,
        CURLOPT_USERAGENT      => 'Facebook\Api\Client (http://github.com/euskadi31/Facebook)',
    );
    ...
    public function __construct($config) 
    {
        if (!function_exists('curl_init')) {
            throw new RuntimeException('Facebook needs the CURL PHP extension.');
        }
        ...
        if (!empty($state)) {
            $this->_state = $this->getPersistentData('state');
        }
    }
    ...
    {
        $this->_fileUploadSupport = $fileUploadSupport;
        return $this;
    }
    ...
    public function getSignedRequest() 
    {
        if (!$this->_signedRequest) {
            ...
            if (isset($_REQUEST['signed_request'])) {
                ...
                $this->_signedRequest = $this->parseSignedRequest(
    ...
    public function getUser() 
    {
        ...
        return $this->_user = $this->getUserFromAvailableData();
    }
    ...
    protected function establishCSRFTokenState()
    {
        if ($this->_state === null) {
            ...
            $this->setPersistentData('state', $this->_state);
        }
    }
